...
class AddSurveyActivity2 : AppCompatActivity() {
...
//        survey.data_insert = "2020/03/02"
        ...
        btn_salvar_vistoria.setOnClickListener {
            ...
            val mBuilder = AlertDialog.Builder(this@AddSurveyActivity2)
    ...
    fun checkPermission(permission: String, requestCode: Int) {
        if (ContextCompat.checkSelfPermission(this@AddSurveyActivity2, permission)
            == PackageManager.PERMISSION_DENIED
        ) { // Requesting the permission
            ActivityCompat.requestPermissions(
                this@AddSurveyActivity2, arrayOf(permission),
                requestCode
            )
        } else {
            takePhotoFromCamera()
...
//        val pictureDialogItems = arrayOf("Selecione foto da galeria", "Capturar foto da camera")
...
//        }
        ...
        imageview!!.setImageBitmap(thumbnail)
        saveImage(thumbnail)
        Toast.makeText(this@AddSurveyActivity2, "Image Saved!", Toast.LENGTH_SHORT).show()
    }
}
